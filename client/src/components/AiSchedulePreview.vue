...
<template>
  <aside class="ai-panel" aria-label="AI 排课预览">
    ...
    <template v-if="suggestion">
      ...
      <p class="preview-time">{{ new Intl.DateTimeFormat('zh-CN', { weekday: 'short', hour: '2-digit', minute: '2-digit', month: 'numeric', day: 'numeric', hourCycle: 'h23' }).format(new Date(suggestion.startAt)) }} · 60 分钟</p>
